...
The filepath is built from the meta values in `banners.json`, so make sure you update these fields to match your project. The path will be generated as follows:

```
<your_sbx_file.HOST><your_sbx_file.dir><banners_json.meta.client_or_agency>/<banners_json.meta.name>/<timestamp>
```
